...
" her
let s:p.insert.left = [ [ '#2c323d', '#aaaaff', s:term_black, s:term_blue, 'bold' ], [ '#d6f4fd', '#3e4452', s:term_blue, s:term_black ] ]
let s:p.insert.right = [ [ '#2c323d', '#aaaaff', s:term_black, s:term_blue ], [ '#d6f4fd', '#3E4452', s:term_white, s:term_grey ], [ '#aaaaff', '#2c323d', s:term_blue, s:term_black ] ]
let s:p.replace.left = [ [ '#2c323d', '#aaaaff', s:term_black, s:term_red, 'bold' ], [ '#d6f4fd', '#3e4452', s:term_red, s:term_black ] ]
let s:p.replace.right = [ [ '#2c323d', '#aaaaff', s:term_black, s:term_red, 'bold' ], s:p.normal.right[1], [ '#aaaaff', '#2c323d', s:term_red, s:term_black ] ]
...
let s:p.normal.error = [ [ '#2c323d', '#aaaaff', s:term_black, s:term_red ] ]
